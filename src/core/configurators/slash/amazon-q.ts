...
const FILE_PATHS: Record<SlashCommandId, string> = {
  proposal: '.amazonq/prompts/cainiaospec-proposal.md',
  apply: '.amazonq/prompts/cainiaospec-apply.md',
  archive: '.amazonq/prompts/cainiaospec-archive.md'
};
...
The user wants to apply the following change. Use the cainiaospec instructions to implement the approved change.
...
The user wants to archive the following deployed change. Use the cainiaospec instructions to archive the change and update specs.
