...
const FILE_PATHS: Record<SlashCommandId, string> = {
  proposal: '.clinerules/workflows/cainiaospec-proposal.md',
  apply: '.clinerules/workflows/cainiaospec-apply.md',
  archive: '.clinerules/workflows/cainiaospec-archive.md'
};
