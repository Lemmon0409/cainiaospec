...
const FILE_PATHS: Record<SlashCommandId, string> = {
  proposal: '.github/prompts/cainiaospec-proposal.prompt.md',
  apply: '.github/prompts/cainiaospec-apply.prompt.md',
  archive: '.github/prompts/cainiaospec-archive.prompt.md'
};
