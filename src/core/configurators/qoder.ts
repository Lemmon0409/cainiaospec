 ...
 * 
 * Configures CainiaoSpec integration for Qoder AI coding assistant.
 * Creates and manages QODER.md configuration file with CainiaoSpec instructions.
 * 
...
export class QoderConfigurator implements ToolConfigurator {
   ...
   * 
   * Creates or updates QODER.md file with CainiaoSpec instructions.
   ...
   * @param {string} openspecDir - Path to cainiaospec directory (unused but required by interface)
  ...
  async configure(projectPath: string, openspecDir: string): Promise<void> {
    ...
    // This ensures Qoder receives the same high-quality CainiaoSpec instructions
